...
SPAM_WORDS = [
    ...
    # Вакансии и найм сотрудников — нам не нужно
    "вакансия", "#вакансия", "ищу сотрудника", "ищем сотрудника",
    "набор сотрудников", "трудоустройство", "официальное трудоустройство",
    "з/п", "зарплата", "оклад", "ставка в месяц",
    "занятость", "полная занятость", "частичная занятость",
    "3-4 часа в день", "часов в день",
    "личный ассистент", "помощник руководителя", "ассистент",
    "удалённая работа", "удаленная работа", "работа на дому",
    "подработка на дому", "центр трудоустройства",
    "проходишь обучение", "обучение пару недель",
    "ищу 14 человек", "набор людей", "команда специалистов",
    "smm специалист", "smm-специалист", "#требуется",
    "контент-завод", "контент завод", "ии-контент",
    "топ-менеджер", "корпорация", "правая рука",
]
